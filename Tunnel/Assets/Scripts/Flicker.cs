...
public class Flicker : MonoBehaviour {
	...
	// How much flicker there should be. 0 = zero flicker, 1 = LOTS of flicker.
	[Range(0.0f, 1.0f)]
	...
	void Update () {
		...
		// Use flickerStrength to work out how much of flickerAmount should 
		// affect the current alpha value. 1.0 = all of it, 0.0 = none.
